...
//   return (
//     <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-[#fcf8f5]">
...
//               <span className="text-black/60">Effortlessly</span>
//             </h1>
...
//               </button>
//             </div>
//             <div className="flex items-center gap-8 pt-6 text-sm text-black/60">
//               <div>
...
// import animationData from "@/assets/animations/fashion designer.json"; // Update with your actual filename

export default function HeroSection() {
  return (
    <section className="pt-15 pb-20 px-4 sm:px-6 lg:px-8 bg-white">
